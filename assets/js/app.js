...
// token đã có sẵn khi đăng nhập, server tự tra lại quyền admin từ token (xem authenticateAdmin bên Code.gs).
function getAdminCredentials() {
    return {
        token: (currentUser && currentUser.token) || localStorage.getItem('ta3_token') || ''
    };
}
